...
func (a *App) runPerformanceTest(sim *simlib.World, cameraState *ui.CameraState, inputState *ui.InputState, profile string, threads int, noLocking bool) {
...
func (a *App) runSingleTest(sim *simlib.World, cameraState *ui.CameraState, inputState *ui.InputState, config PerformanceTestConfig) PerformanceResult {
...
func printPerformanceResults(sim *simlib.World, results []PerformanceResult) {
	fmt.Println("\n" + strings.Repeat("=", 100))
...
func savePerformanceResults(sim *simlib.World, results []PerformanceResult, profile string, threads int, noLocking bool) {
