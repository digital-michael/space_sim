...
func (a *App) newRuntimeSession(systemConfigPath string) (session *runtimeSession, err error) {
	...
	if solIndex >= 0 {
		...
		cameraState.Tracking.Distance = max(float64(starRadius)+75.0, ui.CalculateAutoZoomDistance(starViewRadius, 0.40))
